...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      <div className="logo">
        <h2 className="text-3xl font-bold bg-white text-black p-1 md:bg-transparent md:text-white">Portfolio</h2>
      </div>
      <ul
        className={`menu flex items-center sm:gap-10 gap-2 md:static fixed left-1/2 -translate-x-1/2 md:-translate-x-0 md:opacity-100 bg-white/30
