...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between ">
      ...
      <ul
        className={`menu flex items-center sm:gap-10 -gap-10 md:static fixed left-1/2 -translate-x-1/2 md:-translate-x-0 md:opacity-100 bg-white/30
      ...
      >
        <li>
          <a href="#beranda" className="sm:text-lg text-base font-medium px-1 py-2 rounded hover:bg-violet-600 hover:text-white transition duration-300 block">
            Beranda
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#kontak" className="sm:text-lg text-base font-medium px-1 py-2 rounded hover:bg-violet-600 hover:text-white transition duration-300 block">
            Kontak
          </a>
        </li>
      </ul>
